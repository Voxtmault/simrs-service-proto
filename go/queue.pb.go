...
type UpdateQueueXARequest struct {
	...
	Stage int32  `protobuf:"varint,3,opt,name=stage,proto3" json:"stage,omitempty"` // Current state of the transaction, can be "start", "prepare", "commit", "rollback"
}
...
func (x *UpdateQueueXARequest) GetStage() int32 {
	if x != nil {
		return x.Stage
	}
	return 0
...
var file_queue_proto_rawDesc = []byte{
	...
	0x03, 0x20, 0x01, 0x28, 0x05, 0x52, 0x05, 0x73, 0x74, 0x61, 0x67, 0x65, 0x22, 0x69, 0x0a, 0x15,
