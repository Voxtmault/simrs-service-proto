...
var file_queue_proto_rawDesc = []byte{
	...
	0x75, 0x6e, 0x74, 0x69, 0x6e, 0x67, 0x42, 0x03, 0x5a, 0x01, 0x2e, 0x62, 0x06, 0x70, 0x72, 0x6f,
	0x74, 0x6f, 0x33,
}
...
var file_queue_proto_goTypes = []interface{}{
	...
	(*HelperVar)(nil),           // 3: simrs.HelperVar
	(*Accounting)(nil),          // 4: simrs.Accounting
}
var file_queue_proto_depIdxs = []int32{
	2, // 0: simrs.UpdateQueueRequest.queue:type_name -> simrs.Queue
	3, // 1: simrs.Queue.room:type_name -> simrs.HelperVar
	3, // 2: simrs.Queue.QueueStatus:type_name -> simrs.HelperVar
	4, // 3: simrs.Queue.accounting:type_name -> simrs.Accounting
