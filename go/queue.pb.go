...
type UpdateQueueXARequest struct {
	state         protoimpl.MessageState
	sizeCache     protoimpl.SizeCache
	unknownFields protoimpl.UnknownFields

	Queue *Queue `protobuf:"bytes,1,opt,name=queue,proto3" json:"queue,omitempty"`
	XAID  string `protobuf:"bytes,2,opt,name=XAID,proto3" json:"XAID,omitempty"`   // XA Transaction ID to join
	Stage string `protobuf:"bytes,3,opt,name=stage,proto3" json:"stage,omitempty"` // Current state of the transaction, can be "start", "prepare", "commit", "rollback"
}

func (x *UpdateQueueXARequest) Reset() {
	*x = UpdateQueueXARequest{}
	if protoimpl.UnsafeEnabled {
...
func (x *UpdateQueueXARequest) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*UpdateQueueXARequest) ProtoMessage() {}

func (x *UpdateQueueXARequest) ProtoReflect() protoreflect.Message {
	mi := &file_queue_proto_msgTypes[3]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use UpdateQueueXARequest.ProtoReflect.Descriptor instead.
func (*UpdateQueueXARequest) Descriptor() ([]byte, []int) {
	return file_queue_proto_rawDescGZIP(), []int{3}
}

func (x *UpdateQueueXARequest) GetQueue() *Queue {
	if x != nil {
		return x.Queue
	}
	return nil
...
func (x *UpdateQueueXARequest) GetXAID() string {
	if x != nil {
		return x.XAID
	}
	return ""
...
func (x *UpdateQueueXARequest) GetStage() string {
	if x != nil {
		return x.Stage
	}
	return ""
...
type UpdateQueueXAResponse struct {
	state         protoimpl.MessageState
	sizeCache     protoimpl.SizeCache
	unknownFields protoimpl.UnknownFields
...
func (x *UpdateQueueXAResponse) Reset() {
	*x = UpdateQueueXAResponse{}
	if protoimpl.UnsafeEnabled {
...
func (x *UpdateQueueXAResponse) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*UpdateQueueXAResponse) ProtoMessage() {}

func (x *UpdateQueueXAResponse) ProtoReflect() protoreflect.Message {
	mi := &file_queue_proto_msgTypes[4]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use UpdateQueueXAResponse.ProtoReflect.Descriptor instead.
func (*UpdateQueueXAResponse) Descriptor() ([]byte, []int) {
	return file_queue_proto_rawDescGZIP(), []int{4}
}

func (x *UpdateQueueXAResponse) GetCode() int32 {
	if x != nil {
		return x.Code
	}
	return 0
...
func (x *UpdateQueueXAResponse) GetMessage() string {
	if x != nil {
		return x.Message
	}
	return ""
...
func (x *UpdateQueueXAResponse) GetErrorMessage() string {
	if x != nil {
		return x.ErrorMessage
	}
	return ""
...
var file_queue_proto_rawDesc = []byte{
	...
	,
	...
	,
...
var file_queue_proto_goTypes = []interface{}{
	...
	(*Queue)(nil),                 // 2: simrs.Queue
	(*UpdateQueueXARequest)(nil),  // 3: simrs.UpdateQueueXARequest
	(*UpdateQueueXAResponse)(nil), // 4: simrs.UpdateQueueXAResponse
	(*HelperVar)(nil),             // 5: simrs.HelperVar
	(*Accounting)(nil),            // 6: simrs.Accounting
}
var file_queue_proto_depIdxs = []int32{
	2, // 0: simrs.UpdateQueueRequest.queue:type_name -> simrs.Queue
	...
	2, // 4: simrs.UpdateQueueXARequest.queue:type_name -> simrs.Queue
...
func file_queue_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		...
		file_queue_proto_msgTypes[3].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*UpdateQueueXARequest); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
		...
		file_queue_proto_msgTypes[4].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*UpdateQueueXAResponse); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
